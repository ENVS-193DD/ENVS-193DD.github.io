...
For this class, we have a virtual machine: it allows you to run R and RStudio in a browser (e.g. Google Chrome, Safari, Firefox). [Find the virtual machine here](https://envs193dd.lsit.ucsb.edu/)!  
...
Once you open up the [virtual machine](https://envs193dd.lsit.ucsb.edu/), you'll be asked to log in. Use your UCSB email to do that. You should then get a screen that looks like this:
...
If you're opening this up for the first time, do task 5 in the Getting set up guide called "Change your settings": [Change your settings](https://spring-2026.envs-193dd.github.io/assignments/getting-set-up#task-5.-change-your-settings).  

Additionally, you'll want to set up a new folder for your ENVS 193DD materials. Make a new folder called `ENVS-193DD` by clicking on the "Folder" button in the Files tab in the bottom right.  
